            ...
            <table class="table" style="border: 2px solid rgb(148, 148, 148);">
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach($pelanggan as $tampil_pelanggan)

                        <form action="/proses_update_customer/{{$tampil_pelanggan->pelanggan_id}}" method="post">
                          @method('post')
                          @csrf
            
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td> {{$tampil_pelanggan->pelanggan_id}} </td>

                               

                                    <td>
                                        <input type="text" name="nama_pelanggan" value="{{$tampil_pelanggan->nama_pelanggan}}">
                                    </td>
