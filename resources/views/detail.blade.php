        ...
        <div class="" style="display: flex; height: 100vh;">
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 fixed-left"
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li style="margin-left: 10%; width: 75%;">
                        <a href="/detail" class=""
                            style=" border-radius: 5px;  color: rgb(255, 131, 131); text-decoration: none;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div style="margin-top: 10%; margin-left: 5%; width:70%; display: flex;">
                ...
                <div class="table-responsive table table-striped">
                    ...
                    <div class="diskon" style="border: 2px solid grey; width: 50%; height: 29%; border-radius: 10px;">
                        ...
                        <div style="display: flex;">
                            ...
                            <p>Masukan total diskon</p>


                            @foreach ($detail_produk as $produk)
                                <form action="/diskon/{{ $produk->produk_id }}" method="post">
                                    @method('post')
                                    @csrf

                                    <div style="display: flex; margin-left: 5%;">

                                        <input type="text" class="form-control" placeholder="masukkan diskon"
                                            name="diskon" required>

                                        <button type="submit" class="btn btn-primary"
                                            style="margin-left: 2%">kirim</button>
                        ...
                        <p style="color: red;">Diskon dimasukkan tanpa tanda %</p>
                        <p style="color: red;">Nominal diskon % adalah 0.00 ,contoh 0.1 (1%) , 0.100 (100%)</p>
