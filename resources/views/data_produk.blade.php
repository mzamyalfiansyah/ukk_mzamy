...
<body>
    ...
    <div class="" style="display: flex; height: 100vh;">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 fixed-left"
            style=" background-color:rgb(48, 55, 80); color: white; width: 250px; box-shadow: 0px 0px 5px 0px rgb(99, 99, 99); height: 100%;">

            <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <svg class="bi me-2" style="height: 5%; width: 40px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="/data_produk" class="nav-link link-light"
                        style="background-color: rgb(173, 0, 0); border-radius: 5px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div style="margin-top: 5%; margin-left: 5%; width:70%; ">
            <br>
            <h2 style="font-family:Arial, Helvetica, sans-serif">Stok Barang</h2>


            <div class="table-responsive table table-striped" style="height: 60%;">
                        ...
                        <tr class="table-active">
                            ...
                            <th scope="col">
                                <svg style="color: green" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                                    <path
                    ...
                    <tbody>
                        ...
                        @foreach ($tampil_produk as $produk)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger remove" href="/proses_delete/{{ $produk->produk_id }}">
                                        <!-- <a  class="btn btn-danger remove" href="/proses_delete/{{ $produk->produk_id }}" ></a> -->
                                        <!-- <input type="hidden" value="{{ $produk->produk_id }}"> -->
                                    ...
                                    {{-- DETAIL --}}
                                    <a href="/detail/{{ $produk->produk_id }}" type="submit"
                                        class="btn btn-primary btn-sm" style="margin-left: 10%;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                            <path
            ...
            <div>
                ...
                <p>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#exampleModal" data-bs-whatever="@mdo">Tambahkan Produk</button>
                                    ...
                                    <div class="tambah">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nama_produk"
                                                placeholder="Nama barang" aria-label="username"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="stok"
                                                placeholder="Stok" aria-label="stok" aria-describedby="basic-addon1"
                                                required>
                                        </div>
            ...
            <p>
                <button type="button" class="btn btn-danger"
                    style="background-color: rgb(255, 191, 191); color: red;" data-bs-toggle="modal"
                    data-bs-target="#exampleModal2" data-bs-whatever="@mdo">Produk Dihapus
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <div class="table-responsive table table-striped"
                                ...
                                <table class="table" style="border: 2px solid rgb(148, 148, 148);">
                                    ...
                                    <tbody>
                                            ...
                                            <form action="/restor/{{ $produk_dihapus->produk_id }}" method="post">
                                                @method('post')
                                                @csrf
                                                <tr>
                                                    <td> {{ $no++ }} </td>
