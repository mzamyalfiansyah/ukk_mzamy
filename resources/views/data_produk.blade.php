    ...
    <div style="margin-top: 5%; margin-left: 5%; width:70%; ">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="submit" class="btn btn-primary btn-sm" style="margin-left: 10%;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        <div>
            ...
            <form action="/proses_login" method="POST" >
                ...
                <div class="tambah" style="display: flex">
                    <p style="width: 20%; " >
                        <label for="produk">Nama Produk</label>
                        <input type="text" class="form-control" name="produk" placeholder="Nama barang" aria-label="username" aria-describedby="basic-addon1">
                    </p>
                 
               
                    <p style="width: 20%; margin-left: 5%;">
