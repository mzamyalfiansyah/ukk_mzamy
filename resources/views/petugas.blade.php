      ...
      {{-- Sidebar --}}
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 fixed-left" style=" background-color:rgb(48, 55, 80); color: white; width: 250px; box-shadow: 0px 0px 5px 0px rgb(99, 99, 99); height: 100%;">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <a href="/petugas" class="nav-link link-light"  style="background-color: rgb(173, 0, 0); border-radius: 5px;">
            ...
            <div class="table-responsive table table-striped" style="height: 65%">
                ...
                <?php $no=1 ?>
                            ...
                            @foreach($petugas as $petugas)
                                    ...
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td style="color: brown"> {{$petugas->id}} </td>
                                        ...
                                        <td>
                                          @if(Auth::check() && Auth::user()->status == 'admin')
                                            <a href="/edit_petugas/{{$petugas->id}}" type="submit" class="btn btn-primary btn-sm" style="margin-left: 10%;">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel">Tambahkan Petugas dan Admin</h1>
