                ...
                <div class="box" >
                    ...
                    <form action="/proses_login" method="POST" >
                        ...
                        <p class="input-group mb-3">
                            ...
                            <svg style="width: 80%;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                        ...
                        <p class="input-group mb-3">
                            ...
                            <svg style="width: 80%;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock" viewBox="0 0 16 16">
